...
def main():
    ...
    parser.add_argument("--vertice_dim", type=int, default=6172*3, help='number of vertices - 23370*3 for BIWI dataset')
    ...
    parser.add_argument("--train_subjects", type=str, default="1 2 3 5 6 7 8 9 10")
    parser.add_argument("--val_subjects", type=str, default="1 2 3 5 6 7 8 9 10")
    parser.add_argument("--test_subjects", type=str, default="1 2 3 5 6 7 8 9 10")
